...
public abstract class RequestsPageButton extends MButton {
    protected final RequestsPage requestsPage;


    public RequestsPageButton(Config buttonConfig, RequestsPage requestsPage) {
        super(
                new Color(
