...
public abstract class PersonalPageButton extends MButton {
    protected final PersonalPage personalPage;


    public PersonalPageButton(Config buttonConfig, PersonalPage personalPage) {
        super(
                new Color(
