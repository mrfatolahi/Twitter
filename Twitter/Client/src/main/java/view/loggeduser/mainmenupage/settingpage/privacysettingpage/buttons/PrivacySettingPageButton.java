...
public abstract class PrivacySettingPageButton extends MButton {
    protected final PrivacySettingPage privacySettingPage;


    public PrivacySettingPageButton(Config buttonConfig, PrivacySettingPage privacySettingPage) {
        super(
                new Color(
